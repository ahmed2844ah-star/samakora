...
(function($, window, document, undefined) {
        ...
        initialContent: function(countriesAjaxURL, method, widgetKey, preferentialCountries, preferentialLeagues) {
            ...
            if (preferentialLeagues) {
                $.ajax({
                    ...
                    var resultForPreff = [];
					console.log(preferentialLeagues);
					console.log(LeaguesOdered);
                    ...
                    $(countriesElementRendering).find('div .leagueFavoriteClick .countryListDisplays').on('click', function() {
                        ...
                        $.ajax({
                            ...
                            htmlForFavoriteLeagueDisplay += '<div class="countryListDisplays"><div class="countryLogo" style="background-image: url(\'' + ((res.result[0].country_logo == '' || res.result[0].country_logo == null) ? noImgLocation.noImgUrl : res.result[0].country_logo) + '\');"></div>';
    ...
    $.fn.widgetCountries.defaults = {
        ...
        // Location to your HTML (can be set here but recommended to put it where your activate your widget - index.html)
