<?php
    ...
    Plugin URI: https://allsportsapi.com/football-soccer-wordpress
    Description: Add Football Widget on your website.
    Author: allsportsapi.com
    Version: 1.0.6
    Author URI: https://allsportsapi.com
    */
...
function footballwidgets(){  ?>
    ...
    <script type="text/javascript">
        ...
        jQuery(document).ready(function() {
            ...
            setCookie('ms_preferential_leagues',"<?php echo ms_Main::$settings['ms_preferential_leagues']; ?>",'365');
