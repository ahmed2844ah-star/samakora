<div class="wrap">
    ...
    <div class="form-group">
        ...
        <p style="margin-top: 0;">*Get your widget key from your account <a target="_blank" href="https://allsportsapi.com/wpwidgets/full/download/">click here</a>
        </p>
        <hr>
        ...
        <p style="margin-top: 0;">Default color is #ffc107</p>
        <hr>
        ...
        <p style="margin-top: 0;">Default color is #27282a</p>
        <hr>
        ...
        <p style="margin-top: 0;">*To see complete list of leagues please <a target="_blank"
                                                      href="https://allsportsapi.com/soccer-football-api-coverage">click
                here</a></p>
        <hr>
